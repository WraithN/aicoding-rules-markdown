...
│   ├── DESIGN.cyberpunk.md
│   ├── cyberpunk.preview.html
│   ├── DESIGN.micro-gradient.md
│   ├── micro-gradient.preview.html
...
└── website/                           # 独立站（新增8套）
    ...
    ├── DESIGN.bento.md
    ├── bento.preview.html
    ├── DESIGN.apple-minimal.md
    ├── apple-minimal.preview.html
    ├── DESIGN.big-type.md
    ├── big-type.preview.html
    ├── DESIGN.brutalism.md
    ├── brutalism.preview.html
    ├── DESIGN.3d-parallax.md
    ├── 3d-parallax.preview.html
    ├── DESIGN.magazine.md
    ├── magazine.preview.html
    ├── DESIGN.dark-cyber.md
    └── dark-cyber.preview.html
```
